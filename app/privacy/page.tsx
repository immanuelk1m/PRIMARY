...
const PrivacyPolicyPage = () => {
  return (
    <div>
      <h1>개인정보 처리방침</h1>
      {/* 중요: 본 내용은 일반적인 템플릿으로, 실제 서비스 내용에 맞게 법률 전문가의 검토 후 수정해야 합니다. */}
      <h2>총칙</h2>
      &lt;p&gt;[서비스명] (이하 '회사')는 정보통신망 이용촉진 및 정보보호 등에 관한 법률, 개인정보보호법 등 관련 법령상의 개인정보보호 규정을 준수하며, 관련 법령에 의거한 개인정보 처리방침을 정하여 이용자 권익 보호에 최선을 다하고 있습니다.&lt;/p&gt;
+      &lt;p&gt;[서비스명] (이하 '회사')는 정보통신망 이용촉진 및 정보보호 등에 관한 법률, 개인정보보호법 등 관련 법령에 의거한 개인정보 처리방침을 정하여 이용자 권익 보호에 최선을 다하고 있습니다.&lt;/p&gt;

      <h2>개인정보의 수집 항목 및 이용 목적</h2>
      <p>회사는 다음과 같은 목적으로 개인정보를 수집 및 이용합니다.</p>
      <ul>
        <li>회원 가입 및 관리: 회원 식별, 회원자격 유지·관리, 서비스 부정이용 방지 등</li>
        <li>서비스 제공: 콘텐츠 제공, 맞춤 서비스 제공, 본인 인증 등</li>
        <li>신규 서비스 개발 및 마케팅·광고에의 활용: 신규 서비스 개발 및 맞춤 서비스 제공, 이벤트 정보 및 참여기회 제공, 광고성 정보 제공 등</li>
      </ul>
      <p>수집하는 개인정보 항목은 다음과 같습니다.</p>
      <ul>
        <li>필수 항목: [예: 이메일 주소, 비밀번호, 닉네임]</li>
        <li>선택 항목: [예: 프로필 사진, 생년월일]</li>
      </ul>
      ...
      <ul>
        <li>[예: 계약 또는 청약철회 등에 관한 기록: 5년 (전자상거래 등에서의 소비자보호에 관한 법률)]</li>
        <li>[예: 대금결제 및 재화 등의 공급에 관한 기록: 5년 (전자상거래 등에서의 소비자보호에 관한 법률)]</li>
        <li>[예: 소비자의 불만 또는 분쟁처리에 관한 기록: 3년 (전자상거래 등에서의 소비자보호에 관한 법률)]</li>
        <li>[예: 웹사이트 방문기록: 3개월 (통신비밀보호법)]</li>
      </ul>

      <h2>개인정보의 제3자 제공</h2>
      <p>회사는 정보주체의 동의, 법률의 특별한 규정 등 개인정보 보호법 제17조 및 제18조에 해당하는 경우에만 개인정보를 제3자에게 제공합니다.</p>
      <p>[만약 제3자 제공이 있다면 구체적인 내용을 명시]</p>

      <h2>개인정보 처리 위탁</h2>
      <p>회사는 원활한 개인정보 업무처리를 위하여 다음과 같이 개인정보 처리업무를 위탁하고 있습니다.</p>
      <p>[만약 위탁이 있다면 수탁업체, 위탁업무 내용 등을 명시]</p>
      ...
      <p>권리 행사는 회사에 대해 서면, 전화, 전자우편, 모사전송(FAX) 등을 통하여 하실 수 있으며 회사는 이에 대해 지체 없이 조치하겠습니다.</p>
